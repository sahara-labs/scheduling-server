 ...
 */
            ...
            /**
            *  FindFreeBookingsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FindFreeBookingsType extends au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.SiteIDType
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.TimePeriodType localPeriod ;
                           ...
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.TimePeriodType getPeriod(){
                               return localPeriod;
                           }
                            ...
                            /**
                               ...
                               * @param param Period
                               */
                               public void setPeriod(au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.TimePeriodType param){
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FindFreeBookingsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FindFreeBookingsType",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/multisite","FindFreeBookingsType"));
    ...
    public static class Factory{
        ...
        */
        public static FindFreeBookingsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FindFreeBookingsType object =
                new FindFreeBookingsType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FindFreeBookingsType".equals(type)){
                                ...
                                return (FindFreeBookingsType)au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","period").equals(reader.getName())){
                                                ...
                                                object.setPeriod(au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.TimePeriodType.Factory.parse(reader));
