 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static BookingType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BookingType object =
                new BookingType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BookingType".equals(type)){
                                ...
                                return (BookingType)au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
