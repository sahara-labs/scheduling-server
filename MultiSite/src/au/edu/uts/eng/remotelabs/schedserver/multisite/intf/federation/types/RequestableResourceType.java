...
import au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.ResourceType;
        ...
        public  class RequestableResourceType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RequestableResourceType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RequestableResourceType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RequestableResourceType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static RequestableResourceType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RequestableResourceType object =
                new RequestableResourceType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RequestableResourceType".equals(type)){
                                ...
                                return (RequestableResourceType)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
