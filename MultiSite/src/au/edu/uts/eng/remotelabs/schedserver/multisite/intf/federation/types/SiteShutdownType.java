...
import au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.SiteIDType;
        ...
        public  class SiteShutdownType extends SiteIDType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SiteShutdownType
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SiteShutdownType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SiteShutdownType",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/MultiSiteFederation/","SiteShutdownType"));
    ...
    public static class Factory{
        ...
        */
        public static SiteShutdownType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SiteShutdownType object =
                new SiteShutdownType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SiteShutdownType".equals(type)){
                                ...
                                return (SiteShutdownType)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
