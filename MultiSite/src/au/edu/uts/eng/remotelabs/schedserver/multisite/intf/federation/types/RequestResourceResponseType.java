...
/**
 * RequestResourceResponseType.java
 *
...
import au.edu.uts.eng.remotelabs.schedserver.multisite.intf.types.OperationResponseType;
            ...
            /**
            *  RequestResourceResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RequestResourceResponseType extends OperationResponseType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RequestResourceResponseType
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for RequiresRedirect
                        */

                        
                                    protected boolean localRequiresRedirect ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRequiresRedirectTracker = false ;

                           public boolean isRequiresRedirectSpecified(){
                               return localRequiresRedirectTracker;
                           }
                           ...
                           * @return boolean
                           */
                           public  boolean getRequiresRedirect(){
                               return localRequiresRedirect;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RequiresRedirect
                               */
                               public void setRequiresRedirect(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       localRequiresRedirectTracker =
                                       true;
                                   
                                            this.localRequiresRedirect=param;
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return intf.federation.types.SiteType
                           */
                           public  SiteType getSite(){
                            ...
                            /**
                               ...
                               * @param param Site
                               */
                               public void setSite(SiteType param){
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RequestResourceResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RequestResourceResponseType",
                           xmlWriter);
                   }
                              ...
                              if (reasonTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRequiresRedirectTracker){
                                    namespace = "";
                                    writeStartElement(null, namespace, "requiresRedirect", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("requiresRedirect cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequiresRedirect));
                                               }
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localSite.serialize(new javax.xml.namespace.QName("","site"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/MultiSiteFederation/","RequestResourceResponseType"));
                             ...
                             if (reasonTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequiresRedirect));
                            } if (localSiteTracker){
                            elementList.add(new javax.xml.namespace.QName("",
                                                                      "site"));
    ...
    public static class Factory{
        ...
        */
        public static RequestResourceResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RequestResourceResponseType object =
                new RequestResourceResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RequestResourceResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RequestResourceResponseType)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","requiresRedirect").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRequiresRedirect(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
