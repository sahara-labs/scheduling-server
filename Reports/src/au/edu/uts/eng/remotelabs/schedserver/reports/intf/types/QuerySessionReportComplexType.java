 ...
 */
        ...
        public  class QuerySessionReportComplexType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QuerySessionReportComplexType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QuerySessionReportComplexType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QuerySessionReportComplexType",
                           xmlWriter);
                   }
                                         ...
                                         if (localQueryConstraintsTracker){
                                           ...
                                           localQueryConstraints.serialize(new javax.xml.namespace.QName("","queryConstraints"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localQueryConstraints);
                                } if (localStartTimeTracker){
                                      elementList.add(new javax.xml.namespace.QName("",
                                                                      "startTime"));
    ...
    public static class Factory{
        ...
        */
        public static QuerySessionReportComplexType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QuerySessionReportComplexType object =
                new QuerySessionReportComplexType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QuerySessionReportComplexType".equals(type)){
                                ...
                                return (QuerySessionReportComplexType)au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","queryConstraints").equals(reader.getName())){
                                                ...
                                                object.setQueryConstraints(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.QueryFilterType.Factory.parse(reader));
