                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                         ...
                                         if (localAccessReportDataTracker){
                                           ...
                                           localAccessReportData.serialize(new javax.xml.namespace.QName("","accessReportData"),
                                               factory,xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localAccessReportData);
                                }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","accessReportData").equals(reader.getName())){
                                                ...
                                                object.setAccessReportData(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.AccessReportType.Factory.parse(reader));
