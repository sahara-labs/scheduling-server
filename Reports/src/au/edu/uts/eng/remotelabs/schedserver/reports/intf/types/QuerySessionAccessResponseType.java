...
public class QuerySessionAccessResponseType implements org.apache.axis2.databinding.ADBBean
{
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 8745786130599614189L;
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (this.localAccessReportDataTracker)
        {
            ...
            this.localAccessReportData.serialize(new javax.xml.namespace.QName("", "accessReportData"), factory,
                    xmlWriter);
        }
            ...
            throws org.apache.axis2.databinding.ADBException
    {
        ...
        if (this.localAccessReportDataTracker)
        {
            ...
            elementList.add(this.localAccessReportData);
        }
                ...
                throws java.lang.Exception
        {
            ...
            try
            {
                        ...
                        && new javax.xml.namespace.QName("", "accessReportData").equals(reader.getName()))
                {
                    ...
                    object
                            .setAccessReportData(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.AccessReportType.Factory
                                    .parse(reader));
