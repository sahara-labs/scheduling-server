 ...
 */
        ...
        public  class QueryInfoResponseType
                           ...
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.TypeForQuery_type3 getTypeForQuery(){
                            ...
                            /**
                               ...
                               */
                               public void setTypeForQuery(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.TypeForQuery_type3 param){
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getSelectionResult(){
                               ...
                               */
                              protected void validateSelectionResult(java.lang.String[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param SelectionResult
                              */
                              public void setSelectionResult(java.lang.String[] param){
                              
                                   validateSelectionResult(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localSelectionResultTracker = true;
                                          } else {
                                             localSelectionResultTracker = false;
                             ...
                             */
                             public void addSelectionResult(java.lang.String param){
                                   if (localSelectionResult == null){
                                   localSelectionResult = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSelectionResult);
                               list.add(param);
                               this.localSelectionResult =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QueryInfoResponseType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryInfoResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryInfoResponseType",
                           xmlWriter);
                   }
                                           ...
                                           localTypeForQuery.serialize(new javax.xml.namespace.QName("","typeForQuery"),
                                               factory,xmlWriter);
                                         if (localSelectionResultTracker){
                             if (localSelectionResult!=null) {
                                   namespace = "";
                                   boolean emptyNamespace = namespace == null || namespace.length() == 0;
                                   prefix =  emptyNamespace ? null : xmlWriter.getPrefix(namespace);
                                   for (int i = 0;i < localSelectionResult.length;i++){
                                        
                                            if (localSelectionResult[i] != null){
                                                ...
                                                if (!emptyNamespace) {
                                                    ...
                                                    xmlWriter.writeStartElement("selectionResult");
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSelectionResult[i]));
                                  ...
                                  for (int i = 0;i < localSelectionResult.length;i++){
                                         ...
                                         if (localSelectionResult[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "selectionResult"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSelectionResult[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static QueryInfoResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryInfoResponseType object =
                new QueryInfoResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryInfoResponseType".equals(type)){
                                ...
                                return (QueryInfoResponseType)au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","typeForQuery").equals(reader.getName())){
                                                ...
                                                object.setTypeForQuery(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.TypeForQuery_type3.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","selectionResult").equals(reader.getName())){
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setSelectionResult((java.lang.String[])
