 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.RequestorTypeSequence_type0 getRequestorTypeSequence_type0(){
                               return localRequestorTypeSequence_type0;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RequestorTypeSequence_type0
                               */
                               public void setRequestorTypeSequence_type0(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.RequestorTypeSequence_type0 param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localRequestorTypeSequence_type0Tracker = true;
                                       } else {
                                          localRequestorTypeSequence_type0Tracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RequestorType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localUserIDTracker){
                             ...
                             } if (localRequestorTypeSequence_type0Tracker){
                                            if (localRequestorTypeSequence_type0==null){
                                                 throw new org.apache.axis2.databinding.ADBException("RequestorTypeSequence_type0 cannot be null!!");
                                            }
                                           localRequestorTypeSequence_type0.serialize(null,factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localUserIDTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/reports",
                                    ...
                                    elementList.add(localRequestorTypeSequence_type0);
                                } if (localUserNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("",
                                                                      "userName"));
    ...
    public static class Factory{
        ...
        */
        public static RequestorType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RequestorType object =
                new RequestorType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RequestorType".equals(type)){
                                ...
                                return (RequestorType)au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() ){
                                                ...
                                                object.setRequestorTypeSequence_type0(au.edu.uts.eng.remotelabs.schedserver.reports.intf.types.RequestorTypeSequence_type0.Factory.parse(reader));
