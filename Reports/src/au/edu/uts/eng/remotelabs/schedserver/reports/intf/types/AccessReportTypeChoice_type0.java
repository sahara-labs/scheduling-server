/**
 * AccessReportTypeChoice_type0.java
...
/**
 * AccessReportTypeChoice_type0 bean class
 */

public class AccessReportTypeChoice_type0 implements org.apache.axis2.databinding.ADBBean
{
    /*
     * This type was generated from the piece of schema that had
     * name = AccessReportTypeChoice_type0
    ...
    /**
                 * 
                 */
    private static final long serialVersionUID = 1429989309912999040L;
            ...
            final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
    {
                ...
                parentQName)
        {
            ...
            {
                AccessReportTypeChoice_type0.this.serialize(this.parentQName, factory, xmlWriter);
            }
        };
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (serializeType)
        {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
            {
                this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":AccessReportTypeChoice_type0", xmlWriter);
            }
            else
            {
        ...
        if (this.localUserClassTracker)
        {
            ...
            if (!namespace.equals(""))
            {
                ...
                if (prefix == null)
                {
                    prefix = AccessReportTypeChoice_type0.generatePrefix(namespace);
    ...
    public static class Factory
    {
         ...
         */
        public static AccessReportTypeChoice_type0 parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception
        {
            final AccessReportTypeChoice_type0 object = new AccessReportTypeChoice_type0();
