 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       TimePeriodType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TimePeriodType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TimePeriodType",
    ...
    public static class Factory{
        ...
        */
        public static TimePeriodType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TimePeriodType object =
                new TimePeriodType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TimePeriodType".equals(type)){
                                ...
                                return (TimePeriodType)au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
