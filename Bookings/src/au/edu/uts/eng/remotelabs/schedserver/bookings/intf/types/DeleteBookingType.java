 ...
 */
        ...
        public  class DeleteBookingType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.BookingIDType localBookingID ;
                                

                           /**
                           * Auto generated getter method
                           * @return au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.BookingIDType
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.BookingIDType getBookingID(){
                            ...
                            /**
                               ...
                               */
                               public void setBookingID(au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.BookingIDType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DeleteBookingType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteBookingType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteBookingType",
    ...
    public static class Factory{
        ...
        */
        public static DeleteBookingType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteBookingType object =
                new DeleteBookingType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteBookingType".equals(type)){
                                ...
                                return (DeleteBookingType)au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","bookingID").equals(reader.getName())){
                                                ...
                                                object.setBookingID(au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.BookingIDType.Factory.parse(reader));
