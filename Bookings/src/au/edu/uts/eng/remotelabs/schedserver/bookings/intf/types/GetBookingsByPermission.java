 ...
 */
            ...
            /**
            *  GetBookingsByPermission bean class
            */
        
        public  class GetBookingsByPermission
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://remotelabs.eng.uts.edu.au/schedserver/bookings",
                "getBookingsByPermission",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetBookingsByPermission.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBookingsByPermission",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBookingsByPermission",
    ...
    public static class Factory{
        ...
        */
        public static GetBookingsByPermission parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBookingsByPermission object =
                new GetBookingsByPermission();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBookingsByPermission".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBookingsByPermission)au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
