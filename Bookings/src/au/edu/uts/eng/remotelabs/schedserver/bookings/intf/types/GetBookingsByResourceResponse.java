...
/**
 * GetBookingsByResourceResponse.java
 *
 ...
 */
            ...
            /**
            *  GetBookingsByResourceResponse bean class
            */
        
        public  class GetBookingsByResourceResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://remotelabs.eng.uts.edu.au/schedserver/bookings",
                "getBookingsByResourceResponse",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetBookingsByResourceResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBookingsByResourceResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBookingsByResourceResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetBookingsByResourceResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBookingsByResourceResponse object =
                new GetBookingsByResourceResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBookingsByResourceResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBookingsByResourceResponse)au.edu.uts.eng.remotelabs.schedserver.bookings.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
