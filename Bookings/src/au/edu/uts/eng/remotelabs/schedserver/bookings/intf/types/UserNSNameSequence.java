...
public class UserNSNameSequence implements ADBBean
{
    ...
    public void setUserName(final String param)
    {
        if (param != null)
        {
            this.userNameTracker = true;
        }
        else
        {
            this.userNameTracker = false;
        }

        this.userName = param;
    }
    protected String namespace;
    protected boolean namespaceTracker = false;
    ...
    public void setUserNamespace(final String param)
    {
        if (param != null)
        {
            this.namespaceTracker = true;
        }
        else
        {
            this.namespaceTracker = false;
        }
        ...
        if (serializeType)
        {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
            {
                this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":UserIDTypeSequence_type0", xmlWriter);
            }
            else
            {
