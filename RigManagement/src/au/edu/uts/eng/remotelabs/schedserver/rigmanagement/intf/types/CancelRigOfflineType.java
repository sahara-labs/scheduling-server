 ...
 */
            ...
            /**
            *  CancelRigOfflineType bean class
            */
        
        public  class CancelRigOfflineType extends au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OperationRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CancelRigOfflineType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OfflinePeriodType localPeriod ;
                                

                           /**
                           * Auto generated getter method
                           * @return au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OfflinePeriodType
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OfflinePeriodType getPeriod(){
                               return localPeriod;
                           }
                            ...
                            /**
                               ...
                               * @param param Period
                               */
                               public void setPeriod(au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OfflinePeriodType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CancelRigOfflineType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CancelRigOfflineType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CancelRigOfflineType",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/rigmanagement","CancelRigOfflineType"));
                 if (localRequestorIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static CancelRigOfflineType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelRigOfflineType object =
                new CancelRigOfflineType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CancelRigOfflineType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelRigOfflineType)au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","period").equals(reader.getName())){
                                                ...
                                                object.setPeriod(au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OfflinePeriodType.Factory.parse(reader));
