        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected int localFailureCode ;
                           ...
                           */
                           public  int getFailureCode(){
                            ...
                            /**
                               ...
                               */
                               public void setFailureCode(int param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OperationResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                              ...
                              if (localFailureCodeTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("failureCode");
                                               ...
                                               if (localFailureCode==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("failureCode cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFailureCode));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                             ...
                             if (localFailureCodeTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFailureCode));
                            } if (localFailureReasonTracker){
                                      elementList.add(new javax.xml.namespace.QName("",
                                                                      "failureReason"));
    ...
    public static class Factory{
        ...
        */
        public static OperationResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OperationResponseType object =
                new OperationResponseType();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OperationResponseType".equals(type)){
                                ...
                                return (OperationResponseType)au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","failureCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","failureReason").equals(reader.getName())){
