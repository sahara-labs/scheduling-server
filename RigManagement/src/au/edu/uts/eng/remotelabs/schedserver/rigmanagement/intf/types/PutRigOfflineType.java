 ...
 */
        ...
        public  class PutRigOfflineType extends au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.OperationRequestType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.RigIDType localRig ;
                                

                           /**
                           * Auto generated getter method
                           * @return au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.RigIDType
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.RigIDType getRig(){
                               return localRig;
                           }
                            ...
                            /**
                               ...
                               * @param param Rig
                               */
                               public void setRig(au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.RigIDType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       PutRigOfflineType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PutRigOfflineType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PutRigOfflineType",
                ...
                if (localRequestorIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                            ...
                                            if (localRig==null){
                                                 throw new org.apache.axis2.databinding.ADBException("rig cannot be null!!");
                                            }
                                           localRig.serialize(new javax.xml.namespace.QName("","rig"),
                                               factory,xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/rigmanagement","PutRigOfflineType"));
                 if (localRequestorIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static PutRigOfflineType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PutRigOfflineType object =
                new PutRigOfflineType();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PutRigOfflineType".equals(type)){
                                ...
                                return (PutRigOfflineType)au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","rig").equals(reader.getName())){
                                
                                                object.setRig(au.edu.uts.eng.remotelabs.schedserver.rigmanagement.intf.types.RigIDType.Factory.parse(reader));
