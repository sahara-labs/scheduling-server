...
/**
 * Persona_type1 bean class
 */

public class Persona_type1 implements org.apache.axis2.databinding.ADBBean
{
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://remotelabs.eng.uts.edu.au/schedserver/permissions", "persona_type1", "ns1");
    ...
    protected Persona_type1(final java.lang.String value, final boolean isRegisterValue)
    {
        this.localPersona_type0 = value;
        if (isRegisterValue)
        {

            Persona_type1._table_.put(this.localPersona_type0, this);
    ...
    public static final Persona_type1 ADMIN = new Persona_type1(Persona_type1._ADMIN, true);

    public static final Persona_type1 ACADEMIC = new Persona_type1(Persona_type1._ACADEMIC, true);

    public static final Persona_type1 USER = new Persona_type1(Persona_type1._USER, true);

    public static final Persona_type1 DEMO = new Persona_type1(Persona_type1._DEMO, true);
            ...
            final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
    {
                ...
                Persona_type1.MY_QNAME)
        {
            ...
            {
                Persona_type1.this.serialize(Persona_type1.MY_QNAME, factory, xmlWriter);
            }
        };
        return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(Persona_type1.MY_QNAME, factory, dataSource);
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (!namespace.equals(""))
        {
            ...
            if (prefix == null)
            {
                prefix = Persona_type1.generatePrefix(namespace);
            ...
            throws org.apache.axis2.databinding.ADBException
    {
        ...
        //We can safely assume an element has only one type associated with it
        return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(Persona_type1.MY_QNAME,
    ...
    public static class Factory
    {
        ...
        public static Persona_type1 fromValue(final java.lang.String value) throws java.lang.IllegalArgumentException
        {
            final Persona_type1 enumeration = (Persona_type1)

            Persona_type1._table_.get(value);
        ...
        public static Persona_type1 fromString(final java.lang.String value, final java.lang.String namespaceURI)
        ...
        public static Persona_type1 fromString(final javax.xml.stream.XMLStreamReader xmlStreamReader,
                final java.lang.String content)
        {
            if (content.indexOf(":") > -1)
            {
                ...
                return Persona_type1.Factory.fromString(content, namespaceUri);
            }
            else
            {
                return Persona_type1.Factory.fromString(content, "");
            }
        }
         ...
         */
        public static Persona_type1 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
        {
            Persona_type1 object = null;
                ...
                while (!reader.isEndElement())
                {
                    if (reader.isStartElement() || reader.hasText())
                    {
                        ...
                        if (content.indexOf(":") > 0)
                        {
                            ...
                            object = Persona_type1.Factory.fromString(content, namespaceuri);
                        }
                        else
                        {
                            // this seems to be not a qname send and empty namespace incase of it is
                            // check is done in fromString method
                            object = Persona_type1.Factory.fromString(content, "");
                        }
