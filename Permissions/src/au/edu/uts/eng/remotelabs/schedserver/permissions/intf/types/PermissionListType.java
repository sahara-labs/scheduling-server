...
public class PermissionListType implements org.apache.axis2.databinding.ADBBean
{
    /*
     ...
     * 
     * @param param
     *            au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType
     */
    public void addPermission(final au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType param)
    {
        if (this.localPermission == null)
        {
            this.localPermission = new au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType[] {};
        }
        ...
        list.add(param);
        this.localPermission = (au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType[]) list
                .toArray(new au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType[list.size()]);
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (this.localPermissionTracker)
        {
            if (this.localPermission != null)
            {
                for (final PermissionType element : this.localPermission)
                {
                    if (element != null)
                    {
    ...
    public static class Factory
    {
         ...
         */
        public static PermissionListType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception
        {
            ...
            try
            {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if (fullTypeName != null)
                    {
                        ...
                        if (!"PermissionListType".equals(type))
                        {
                            ...
                            return (PermissionListType) au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.ExtensionMapper
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("", "permission").equals(reader.getName()))
                {
                    ...
                    list1.add(au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType.Factory
                            .parse(reader));
                    ...
                    while (!loopDone1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                list1
                                        .add(au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType.Factory
                                                .parse(reader));
                    ...
                    object
                            .setPermission((au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType[]) org.apache.axis2.databinding.utils.ConverterUtil
                                    .convertToArray(
                                            au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.PermissionType.class,
                                            list1));
