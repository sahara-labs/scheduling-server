...
/**
 * ResourceClass_type1 bean class
 */

public class ResourceClass_type1 implements org.apache.axis2.databinding.ADBBean
{
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://remotelabs.eng.uts.edu.au/schedserver/permissions", "resourceClass_type1", "ns1");
    ...
    protected ResourceClass_type1(final java.lang.String value, final boolean isRegisterValue)
    {
        this.localResourceClass_type0 = value;
        if (isRegisterValue)
        {

            ResourceClass_type1._table_.put(this.localResourceClass_type0, this);
    ...
    public static final ResourceClass_type1 TYPE = new ResourceClass_type1(ResourceClass_type1._TYPE, true);

    public static final ResourceClass_type1 RIG = new ResourceClass_type1(ResourceClass_type1._RIG, true);

    public static final ResourceClass_type1 CAPABILITY = new ResourceClass_type1(ResourceClass_type1._CAPABILITY, true);
            ...
            final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
    {
                ...
                ResourceClass_type1.MY_QNAME)
        {
            ...
            {
                ResourceClass_type1.this.serialize(ResourceClass_type1.MY_QNAME, factory, xmlWriter);
            }
        };
        return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(ResourceClass_type1.MY_QNAME, factory, dataSource);
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (!namespace.equals(""))
        {
            ...
            if (prefix == null)
            {
                prefix = ResourceClass_type1.generatePrefix(namespace);
    ...
    public static class Factory
    {
        ...
        public static ResourceClass_type1 fromValue(final java.lang.String value)
                throws java.lang.IllegalArgumentException
        {
            final ResourceClass_type1 enumeration = (ResourceClass_type1)

            ResourceClass_type1._table_.get(value);
        ...
        public static ResourceClass_type1 fromString(final java.lang.String value, final java.lang.String namespaceURI)
                throws java.lang.IllegalArgumentException
        {
            try
            {
        ...
        public static ResourceClass_type1 fromString(final javax.xml.stream.XMLStreamReader xmlStreamReader,
                final java.lang.String content)
        {
            if (content.indexOf(":") > -1)
            {
                ...
                return ResourceClass_type1.Factory.fromString(content, namespaceUri);
            }
            else
            {
                return ResourceClass_type1.Factory.fromString(content, "");
            }
        }
         ...
         */
        public static ResourceClass_type1 parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception
        {
            ResourceClass_type1 object = null;
                ...
                while (!reader.isEndElement())
                {
                    if (reader.isStartElement() || reader.hasText())
                    {
                        ...
                        if (content.indexOf(":") > 0)
                        {
                            ...
                            object = ResourceClass_type1.Factory.fromString(content, namespaceuri);
                        }
                        else
                        {
                            // this seems to be not a qname send and empty namespace incase of it is
                            // check is done in fromString method
                            object = ResourceClass_type1.Factory.fromString(content, "");
                        }
