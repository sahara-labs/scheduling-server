...
public class UserLockType extends au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.UserLockIDType implements
        org.apache.axis2.databinding.ADBBean
{
     ...
     */
    protected boolean localLockKeyTracker = false;
    ...
    public void setLockKey(final java.lang.String param)
    {
        ...
        if (param != null)
        {
            ...
            this.localLockKeyTracker = true;
        }
        else
        {
            this.localLockKeyTracker = false;
    ...
    public static class Factory
    {
         ...
         */
        public static UserLockType parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
        {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if (fullTypeName != null)
                    {
                        ...
                        if (!"UserLockType".equals(type))
                        {
                            ...
                            return (UserLockType) au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.ExtensionMapper
