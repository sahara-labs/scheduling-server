...
public class ResourceIDType implements org.apache.axis2.databinding.ADBBean
{
    /*
     ...
     *            ResourceName
     */
    public void setResourceName(final java.lang.String param)
    {
        ...
        {
            this.localResourceNameTracker = false;
            ...
            org.apache.axis2.databinding.ADBException
    {
        ...
        if (this.localResourceIDTracker)
        {
            ...
            if (this.localResourceID == java.lang.Integer.MIN_VALUE)
            {
            ...
            else
            {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(this.localResourceID));
            }
        ...
        if (this.localResourceNameTracker)
        {
            ...
            else
            {
                ...
                xmlWriter.writeCharacters(this.localResourceName);
            ...
            throws org.apache.axis2.databinding.ADBException
    {
        ...
        if (this.localResourceIDTracker)
        {
            ...
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localResourceID));
        }
        if (this.localResourceNameTracker)
        {
            elementList.add(new javax.xml.namespace.QName("", "resourceName"));

            if (this.localResourceName != null)
            {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
                        .convertToString(this.localResourceName));
            }
            else
            {
                throw new org.apache.axis2.databinding.ADBException("resourceName cannot be null!!");
    ...
    public static class Factory
    {
         ...
         */
        public static ResourceIDType parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
        {
            ...
            try
            {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
                {
                    ...
                    if (fullTypeName != null)
                    {
                        ...
                        if (!"ResourceIDType".equals(type))
                        {
                            ...
                            return (ResourceIDType) au.edu.uts.eng.remotelabs.schedserver.permissions.intf.types.ExtensionMapper
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("", "resourceID").equals(reader.getName()))
                {
                    ...
                    object.setResourceID(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("", "resourceName").equals(reader.getName()))
                {
