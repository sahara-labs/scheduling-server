...
public class LabConnectorMessageReceiverInOut extends
        org.apache.axis2.receivers.AbstractInOutMessageReceiver
{
        ...
        try
        {
                            ...
                            .xmlNameToJava(op.getName().getLocalPart())) != null))
            {
                ...
                if ("getExperimentResults".equals(methodName))
                {
                    ...
                    GetExperimentResults wrappedParam = (GetExperimentResults) fromOM(
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getExperimentResultsResponse49, false);
                }
                else
                ...
                if ("deleteSavedUserExperimentInput".equals(methodName))
                {
                    ...
                    DeleteSavedUserExperimentInput wrappedParam = (DeleteSavedUserExperimentInput) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            deleteSavedUserExperimentInputResponse51, false);
                }
                else
                ...
                if ("getSavedUserExperimentInput".equals(methodName))
                {
                    ...
                    GetSavedUserExperimentInput wrappedParam = (GetSavedUserExperimentInput) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getSavedUserExperimentInputResponse53, false);
                }
                else
                ...
                if ("setUserPermissions".equals(methodName))
                {
                    ...
                    SetUserPermissions wrappedParam = (SetUserPermissions) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            setUserPermissionsResponse55, false);
                }
                else
                ...
                if ("getLabStatus".equals(methodName))
                {
                    ...
                    GetLabStatus wrappedParam = (GetLabStatus) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(), GetLabStatus.class,
                            getEnvelopeNamespaces(msgContext.getEnvelope()));
                ...
                if ("getExperimentID".equals(methodName))
                {
                    ...
                    GetExperimentID wrappedParam = (GetExperimentID) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(), GetExperimentID.class,
                            getEnvelopeNamespaces(msgContext.getEnvelope()));
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getExperimentIDResponse59, false);
                }
                else
                ...
                if ("saveExperimentResults".equals(methodName))
                {
                    ...
                    SaveExperimentResults wrappedParam = (SaveExperimentResults) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            saveExperimentResultsResponse61, false);
                }
                else
                ...
                if ("saveUserExperimentInput".equals(methodName))
                {
                    ...
                    SaveUserExperimentInput wrappedParam = (SaveUserExperimentInput) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            saveUserExperimentInputResponse63, false);
                }
                else
                ...
                if ("getExperimentSpecs".equals(methodName))
                {
                    ...
                    GetExperimentSpecs wrappedParam = (GetExperimentSpecs) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getExperimentSpecsResponse65, false);
                }
                else
                ...
                if ("getInteractiveExperimentSession".equals(methodName))
                {
                    ...
                    GetInteractiveExperimentSession wrappedParam = (GetInteractiveExperimentSession) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getInteractiveExperimentSessionResponse67, false);
                }
                else
                ...
                if ("getMaintenanceTime".equals(methodName))
                {
                    ...
                    GetMaintenanceTime wrappedParam = (GetMaintenanceTime) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getMaintenanceTimeResponse69, false);
                }
                else
                ...
                if ("cancelBookingTime".equals(methodName))
                {
                    ...
                    CancelBookingTime wrappedParam = (CancelBookingTime) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            cancelBookingTimeResponse71, false);
                }
                else
                ...
                if ("getLabInfo".equals(methodName))
                {
                    ...
                    GetLabInfo wrappedParam = (GetLabInfo) fromOM(msgContext
                            .getEnvelope().getBody().getFirstElement(),
                            GetLabInfo.class, getEnvelopeNamespaces(msgContext
                                    .getEnvelope()));
                ...
                if ("setMaintenanceTime".equals(methodName))
                {
                    ...
                    SetMaintenanceTime wrappedParam = (SetMaintenanceTime) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            setMaintenanceTimeResponse75, false);
                }
                else
                ...
                if ("getLabID".equals(methodName))
                {
                    ...
                    GetLabID wrappedParam = (GetLabID) fromOM(msgContext
                            .getEnvelope().getBody().getFirstElement(),
                            GetLabID.class, getEnvelopeNamespaces(msgContext
                                    .getEnvelope()));
                ...
                if ("submitExperiment".equals(methodName))
                {
                    ...
                    SubmitExperiment wrappedParam = (SubmitExperiment) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(), SubmitExperiment.class,
                            getEnvelopeNamespaces(msgContext.getEnvelope()));
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            submitExperimentResponse79, false);
                }
                else
                ...
                if ("scheduleBookingTime".equals(methodName))
                {
                    ...
                    ScheduleBookingTime wrappedParam = (ScheduleBookingTime) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            scheduleBookingTimeResponse81, false);
                }
                else
                ...
                if ("getToken".equals(methodName))
                {
                    ...
                    GetToken wrappedParam = (GetToken) fromOM(msgContext
                            .getEnvelope().getBody().getFirstElement(),
                            GetToken.class, getEnvelopeNamespaces(msgContext
                                    .getEnvelope()));
                ...
                if ("cancelMaintenanceTime".equals(methodName))
                {
                    ...
                    CancelMaintenanceTime wrappedParam = (CancelMaintenanceTime) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            cancelMaintenanceTimeResponse85, false);
                }
                else
                ...
                if ("releaseSlave".equals(methodName))
                {
                    ...
                    ReleaseSlave wrappedParam = (ReleaseSlave) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(), ReleaseSlave.class,
                            getEnvelopeNamespaces(msgContext.getEnvelope()));
                ...
                if ("getExperimentType".equals(methodName))
                {
                    ...
                    GetExperimentType wrappedParam = (GetExperimentType) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getExperimentTypeResponse89, false);
                }
                else
                ...
                if ("getExperimentStatus".equals(methodName))
                {
                    ...
                    GetExperimentStatus wrappedParam = (GetExperimentStatus) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getExperimentStatusResponse91, false);
                }
                else
                ...
                if ("releaseExperiment".equals(methodName))
                {
                    ...
                    ReleaseExperiment wrappedParam = (ReleaseExperiment) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            releaseExperimentResponse93, false);
                }
                else
                ...
                if ("getUserPermissions".equals(methodName))
                {
                    ...
                    GetUserPermissions wrappedParam = (GetUserPermissions) fromOM(
                            msgContext.getEnvelope().getBody()
                                    .getFirstElement(),
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getUserPermissionsResponse95, false);
    ...
    //
    private org.apache.axiom.om.OMElement toOM(GetExperimentResults param,
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetExperimentResultsResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            DeleteSavedUserExperimentInput param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            DeleteSavedUserExperimentInputResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
        ...
        try
        {
            return param.getOMElement(
                    DeleteSavedUserExperimentInputResponse.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        }
        catch (org.apache.axis2.databinding.ADBException e)
        {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetSavedUserExperimentInput param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetSavedUserExperimentInputResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        ...
        {
            return param.getOMElement(
                    GetSavedUserExperimentInputResponse.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        }
        catch (org.apache.axis2.databinding.ADBException e)
        {
    ...
    private org.apache.axiom.om.OMElement toOM(SetUserPermissions param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            SetUserPermissionsResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabStatus param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabStatusResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentID param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentIDResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(SaveExperimentResults param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            SaveExperimentResultsResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(SaveUserExperimentInput param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            SaveUserExperimentInputResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentSpecs param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetExperimentSpecsResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetInteractiveExperimentSession param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetInteractiveExperimentSessionResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
        ...
        {
            return param.getOMElement(
                    GetInteractiveExperimentSessionResponse.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        }
        catch (org.apache.axis2.databinding.ADBException e)
        {
    ...
    private org.apache.axiom.om.OMElement toOM(GetMaintenanceTime param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetMaintenanceTimeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(CancelBookingTime param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(CancelBookingTimeResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabInfo param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabInfoResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(SetMaintenanceTime param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            SetMaintenanceTimeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabID param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetLabIDResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(SubmitExperiment param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(SubmitExperimentResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(ScheduleBookingTime param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            ScheduleBookingTimeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetToken param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetTokenResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(CancelMaintenanceTime param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            CancelMaintenanceTimeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(ReleaseSlave param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(ReleaseSlaveResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentType param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentTypeResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetExperimentStatus param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetExperimentStatusResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(ReleaseExperiment param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(ReleaseExperimentResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(GetUserPermissions param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
    ...
    private org.apache.axiom.om.OMElement toOM(
            GetUserPermissionsResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetExperimentResultsResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(SetUserPermissionsResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            GetLabStatusResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetLabStatusResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            GetExperimentIDResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetExperimentIDResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(SaveExperimentResultsResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(
                            SaveUserExperimentInputResponse.MY_QNAME, factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetExperimentSpecsResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetMaintenanceTimeResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            CancelBookingTimeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(CancelBookingTimeResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            GetLabInfoResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetLabInfoResponse.MY_QNAME, factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(SetMaintenanceTimeResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory, GetLabIDResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetLabIDResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            SubmitExperimentResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(SubmitExperimentResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(ScheduleBookingTimeResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory, GetTokenResponse param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetTokenResponse.MY_QNAME, factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(CancelMaintenanceTimeResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            ReleaseSlaveResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(ReleaseSlaveResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            GetExperimentTypeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetExperimentTypeResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetExperimentStatusResponse.MY_QNAME,
                            factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
            org.apache.axiom.soap.SOAPFactory factory,
            ReleaseExperimentResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(ReleaseExperimentResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        try
        {
            ...
            emptyEnvelope.getBody().addChild(
                    param.getOMElement(GetUserPermissionsResponse.MY_QNAME,
                            factory));
            ...
            throws org.apache.axis2.AxisFault
    {
        ...
        try
        {
            ...
            if (GetExperimentResults.class.equals(type))
            {
                ...
                return GetExperimentResults.Factory.parse(param
            ...
            if (GetExperimentResultsResponse.class.equals(type))
            {
                ...
                return GetExperimentResultsResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (DeleteSavedUserExperimentInput.class.equals(type))
            {
                ...
                return DeleteSavedUserExperimentInput.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (DeleteSavedUserExperimentInputResponse.class.equals(type))
            {
                ...
                return DeleteSavedUserExperimentInputResponse.Factory
            ...
            if (GetSavedUserExperimentInput.class.equals(type))
            {
                ...
                return GetSavedUserExperimentInput.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetSavedUserExperimentInputResponse.class.equals(type))
            {
                ...
                return GetSavedUserExperimentInputResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SetUserPermissions.class.equals(type))
            {
                ...
                return SetUserPermissions.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SetUserPermissionsResponse.class.equals(type))
            {
                ...
                return SetUserPermissionsResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabStatus.class.equals(type))
            {
                ...
                return GetLabStatus.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabStatusResponse.class.equals(type))
            {
                ...
                return GetLabStatusResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentID.class.equals(type))
            {
                ...
                return GetExperimentID.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentIDResponse.class.equals(type))
            {
                ...
                return GetExperimentIDResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SaveExperimentResults.class.equals(type))
            {
                ...
                return SaveExperimentResults.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SaveExperimentResultsResponse.class.equals(type))
            {
                ...
                return SaveExperimentResultsResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SaveUserExperimentInput.class.equals(type))
            {
                ...
                return SaveUserExperimentInput.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SaveUserExperimentInputResponse.class.equals(type))
            {
                ...
                return SaveUserExperimentInputResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentSpecs.class.equals(type))
            {
                ...
                return GetExperimentSpecs.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentSpecsResponse.class.equals(type))
            {
                ...
                return GetExperimentSpecsResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetInteractiveExperimentSession.class.equals(type))
            {
                ...
                return GetInteractiveExperimentSession.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetInteractiveExperimentSessionResponse.class.equals(type))
            {
                ...
                return GetInteractiveExperimentSessionResponse.Factory
                        .parse(param.getXMLStreamReaderWithoutCaching());
            ...
            if (GetMaintenanceTime.class.equals(type))
            {
                ...
                return GetMaintenanceTime.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetMaintenanceTimeResponse.class.equals(type))
            {
                ...
                return GetMaintenanceTimeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (CancelBookingTime.class.equals(type))
            {
                ...
                return CancelBookingTime.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (CancelBookingTimeResponse.class.equals(type))
            {
                ...
                return CancelBookingTimeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabInfo.class.equals(type))
            {
                ...
                return GetLabInfo.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabInfoResponse.class.equals(type))
            {
                ...
                return GetLabInfoResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SetMaintenanceTime.class.equals(type))
            {
                ...
                return SetMaintenanceTime.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SetMaintenanceTimeResponse.class.equals(type))
            {
                ...
                return SetMaintenanceTimeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabID.class.equals(type))
            {
                ...
                return GetLabID.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetLabIDResponse.class.equals(type))
            {
                ...
                return GetLabIDResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SubmitExperiment.class.equals(type))
            {
                ...
                return SubmitExperiment.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (SubmitExperimentResponse.class.equals(type))
            {
                ...
                return SubmitExperimentResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ScheduleBookingTime.class.equals(type))
            {
                ...
                return ScheduleBookingTime.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ScheduleBookingTimeResponse.class.equals(type))
            {
                ...
                return ScheduleBookingTimeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetToken.class.equals(type))
            {
                ...
                return GetToken.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetTokenResponse.class.equals(type))
            {
                ...
                return GetTokenResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (CancelMaintenanceTime.class.equals(type))
            {
                ...
                return CancelMaintenanceTime.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (CancelMaintenanceTimeResponse.class.equals(type))
            {
                ...
                return CancelMaintenanceTimeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ReleaseSlave.class.equals(type))
            {
                ...
                return ReleaseSlave.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ReleaseSlaveResponse.class.equals(type))
            {
                ...
                return ReleaseSlaveResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentType.class.equals(type))
            {
                ...
                return GetExperimentType.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentTypeResponse.class.equals(type))
            {
                ...
                return GetExperimentTypeResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentStatus.class.equals(type))
            {
                ...
                return GetExperimentStatus.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetExperimentStatusResponse.class.equals(type))
            {
                ...
                return GetExperimentStatusResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ReleaseExperiment.class.equals(type))
            {
                ...
                return ReleaseExperiment.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (ReleaseExperimentResponse.class.equals(type))
            {
                ...
                return ReleaseExperimentResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetUserPermissions.class.equals(type))
            {
                ...
                return GetUserPermissions.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (GetUserPermissionsResponse.class.equals(type))
            {
                ...
                return GetUserPermissionsResponse.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
