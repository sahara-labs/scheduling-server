...
package au.edu.labshare.schedserver.scormpackager.types;
        ...
        public  class ValidatePIFResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validatePIFResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validatePIFResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidatePIFResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidatePIFResponse object =
                new ValidatePIFResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validatePIFResponse".equals(type)){
                                ...
                                return (ValidatePIFResponse)au.edu.labshare.schedserver.scormpackager.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
