 ...
 */
        ...
        public  class DeletePIFResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deletePIFResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deletePIFResponse",
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("deleteResponse");
                                               ...
                                               if (false) {
                                                         ...
                                                         throw new org.apache.axis2.databinding.ADBException("deleteResponse cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDeleteResponse));
    ...
    public static class Factory{
        ...
        */
        public static DeletePIFResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeletePIFResponse object =
                new DeletePIFResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deletePIFResponse".equals(type)){
                                ...
                                return (DeletePIFResponse)au.edu.labshare.schedserver.scormpackager.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
