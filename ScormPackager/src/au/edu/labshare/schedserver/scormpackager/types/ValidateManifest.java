 ...
 */
public class ValidateManifest implements org.apache.axis2.databinding.ADBBean
{
	private static final long serialVersionUID = 1L;
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://labshare.edu.au:8080/ScormPackager/", "validateManifest", "ns1");
     ...
     */
	protected java.lang.String localPathManifest ;
    
	/**
	 * Auto generated getter method
	 * @return java.lang.String
	 */
	public java.lang.String getPathManifest()
	{
	 ...
	 */
	public void setPathManifest(java.lang.String param)
	{
                               ...
                               boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
    {
		...
		if(serializeType)
		{
			...
			{
				writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type", namespacePrefix+":validateManifest", xmlWriter);
			} 
			else 
			{
				writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type", "validateManifest", xmlWriter);
			}
		}
		...
		{
			xmlWriter.writeCharacters(localPathManifest);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException
	{
		...
		elementList.add(new javax.xml.namespace.QName("", "pathManifest"));
	...
	public static class Factory
	{
		...
		{
			ValidateManifest object = new ValidateManifest();
            ...
            try 
            {
            	...
            	if(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type") != null)
            	{
            		...
            		if(fullTypeName != null)
            		{
            			...
            			if(!"validateManifest".equals(type))
            			{
            				...
            				return (ValidateManifest)au.edu.labshare.schedserver.scormpackager.types.ExtensionMapper.getTypeObject(nsUri,type,reader);
            			}
            		}
            	}
                ...
                if(reader.isStartElement() && new javax.xml.namespace.QName("","pathManifest").equals(reader.getName()))
                {
                	...
                	object.setPathManifest(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                	reader.next();
