 ...
 */
        ...
        public  class DeleteSCOResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteSCOResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteSCOResponse",
    ...
    public static class Factory{
        ...
        */
        public static DeleteSCOResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteSCOResponse object =
                new DeleteSCOResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteSCOResponse".equals(type)){
                                ...
                                return (DeleteSCOResponse)au.edu.labshare.schedserver.scormpackager.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
