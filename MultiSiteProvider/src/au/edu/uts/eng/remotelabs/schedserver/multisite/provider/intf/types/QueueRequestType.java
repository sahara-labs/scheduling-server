 ...
 */
        ...
        public  class QueueRequestType extends au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.SiteIDType
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueueRequestType".equals(type)){
                                ...
                                return (QueueRequestType)au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
