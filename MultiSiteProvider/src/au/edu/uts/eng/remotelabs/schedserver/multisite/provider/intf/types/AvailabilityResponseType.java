 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for IsQueueable
                        */

                        
                                    protected boolean localIsQueueable ;
                           ...
                           */
                           public  boolean getIsQueueable(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IsQueueable
                               */
                               public void setIsQueueable(boolean param){
                            
                                            this.localIsQueueable=param;
                        ...
                        */
                        ...
                        /**
                        * field for IsCodeAssignable
                        */

                        
                                    protected boolean localIsCodeAssignable ;
                           ...
                           */
                           public  boolean getIsCodeAssignable(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IsCodeAssignable
                               */
                               public void setIsCodeAssignable(boolean param){
                            
                                            this.localIsCodeAssignable=param;
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[] localQueueTarget ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isQueueTargetSpecified(){
                               return localQueueTargetTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[]
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[] getQueueTarget(){
                               ...
                               */
                              protected void validateQueueTarget(au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[] param){
                              ...
                              */
                              public void setQueueTarget(au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[] param){
                              
                                   validateQueueTarget(param);

                               localQueueTargetTracker = param != null;
                             ...
                             * @param param au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType
                             */
                             public void addQueueTarget(au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType param){
                                   if (localQueueTarget == null){
                                   localQueueTarget = new au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localQueueTarget);
                             ...
                             (au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[])list.toArray(
                            new au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AvailabilityResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "viable", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "hasFree", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "isQueueable", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("isQueueable cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsQueueable));
                                               }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "isCodeAssignable", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("isCodeAssignable cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsCodeAssignable));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsQueueable));
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsCodeAssignable));
    ...
    public static class Factory{
        ...
        */
        public static AvailabilityResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AvailabilityResponseType object =
                new AvailabilityResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AvailabilityResponseType".equals(type)){
                                ...
                                return (AvailabilityResponseType)au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","isQueueable").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setIsQueueable(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","isCodeAssignable").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setIsCodeAssignable(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
                                    ...
                                    list7.add(au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType.Factory.parse(reader));
                                                        ...
                                                        object.setQueueTarget((au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.QueueTargetType.class,
                                                                list7));
