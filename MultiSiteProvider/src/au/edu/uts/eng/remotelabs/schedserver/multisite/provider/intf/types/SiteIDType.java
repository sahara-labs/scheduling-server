 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static SiteIDType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SiteIDType object =
                new SiteIDType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SiteIDType".equals(type)){
                                ...
                                return (SiteIDType)au.edu.uts.eng.remotelabs.schedserver.multisite.provider.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
