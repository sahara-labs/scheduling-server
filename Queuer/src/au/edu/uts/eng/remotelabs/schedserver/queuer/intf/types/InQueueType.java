 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for QueueSuccessful
                        */

                        
                                    protected boolean localQueueSuccessful ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localQueueSuccessfulTracker = false ;
                           ...
                           */
                           public  boolean getQueueSuccessful(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param QueueSuccessful
                               */
                               public void setQueueSuccessful(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       
                                               if (false) {
                                           localQueueSuccessfulTracker = false;
                                              
                                       } else {
                                          localQueueSuccessfulTracker = true;
                                       }
                                   
                                            this.localQueueSuccessful=param;
                        ...
                        */
                                    ...
                                    protected au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType localAssignedResource ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType getAssignedResource(){
                            ...
                            /**
                               ...
                               */
                               public void setAssignedResource(au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAssignedResourceTracker = true;
                                       } else {
                                          localAssignedResourceTracker = false;
                        ...
                        /**
                        * field for QueuedResouce
                        */

                        
                                    protected au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType localQueuedResouce ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localQueuedResouceTracker = false ;
                           ...
                           * @return au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType
                           */
                           public  au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType getQueuedResouce(){
                               return localQueuedResouce;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param QueuedResouce
                               */
                               public void setQueuedResouce(au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ResourceIDType param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localQueuedResouceTracker = true;
                                       } else {
                                          localQueuedResouceTracker = false;
                                              
                                       }
                                   
                                            this.localQueuedResouce=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       InQueueType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
    ...
    public static class Factory{
        ...
        */
        public static InQueueType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InQueueType object =
                new InQueueType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InQueueType".equals(type)){
                                ...
                                return (InQueueType)au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
