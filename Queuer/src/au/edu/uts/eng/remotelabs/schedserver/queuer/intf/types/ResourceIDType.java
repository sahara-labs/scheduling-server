 ...
 */
        ...
        public  class ResourceIDType extends au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.OperationRequestType
                               ...
                               */
                               public void setResourceName(java.lang.String param){
                                       ...
                                       if (param != null){
                                          ...
                                          localResourceNameTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ResourceIDType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ResourceIDType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ResourceIDType",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/queuer","ResourceIDType"));
                 if (requestorIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static ResourceIDType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ResourceIDType object =
                new ResourceIDType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ResourceIDType".equals(type)){
                                ...
                                return (ResourceIDType)au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() ){
                                                ...
                                                object.setRequestorNSNameSequence(au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.RequestorNSNameSequence.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","resourceName").equals(reader.getName())){
