 ...
 */
                           ...
                           */
                           public  int getPermissionID(){
                            ...
                            /**
                               ...
                               */
                               public void setPermissionID(int param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       PermissionIDType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PermissionIDType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PermissionIDType",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("permissionID");
                                               ...
                                               if (localPermissionID==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("permissionID cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPermissionID));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/queuer","PermissionIDType"));
                 if (localRequestorIDTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://remotelabs.eng.uts.edu.au/schedserver/queuer",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPermissionID));
    ...
    public static class Factory{
        ...
        */
        public static PermissionIDType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PermissionIDType object =
                new PermissionIDType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PermissionIDType".equals(type)){
                                ...
                                return (PermissionIDType)au.edu.uts.eng.remotelabs.schedserver.queuer.intf.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
